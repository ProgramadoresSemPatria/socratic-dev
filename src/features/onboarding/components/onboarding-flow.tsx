...
import { LevelStep, SummaryStep, TrackStep } from './steps'
            ...
            <div className='container-main grid w-full max-w-6xl gap-10 lg:grid-cols-[minmax(0,5fr)_minmax(0,7fr)] lg:gap-20'>
                  ...
                  {t.stepLabels.map((label, idx) => (
                    <div
                      ...
                      className={cn(
                        ...
                        idx === step ? 'text-ink' : 'text-muted-foreground/50',
                      )}
                    >
              ...
              <div className='pb-4'>
                <div>
                  ...
                  {step === 1 && <LevelStep level={level} onLevel={setLevel} />}
                  {step === 2 && (
                    <SummaryStep track={track} stack={stack} level={level} />
                  )}
                </div>
